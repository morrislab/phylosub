...
def run(fin,fout='./best',out2='top_k_trees',out3='clonal_frequencies',out4='llh_trace',num_samples=100,mh_itr=100,rand_seed=1):
	...
	for iter in range(-burnin,num_samples):
		...
		mh_acc = metropolis(tssb,mh_itr,mh_std,mh_burnin,NTPS)
		times.append(time.time())
